    ...
    return (
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-12">
           ...
           <Rotate top left>
              <Card>
                <Card.Img className=" img-fluid mb-3" variant="top" src={ServicesOne} />
                <h6>Villa On Washington Avenue</h6>
                  <small className="text-muted text-center mb-3 fw-bold"><FontAwesomeIcon className="text-dark" icon={faMapMarkerAlt} /> Dhaka, Bangladesh</small>
              </Card>
              </Rotate>
            </CardGroup>
           </div>
          ...
          <div class="col-lg-4 col-md-6 col-12">
           ...
           <Rotate bottom left>
              <Card>
                <Card.Img className=" img-fluid mb-3" variant="top" src={ServicesTow} />
